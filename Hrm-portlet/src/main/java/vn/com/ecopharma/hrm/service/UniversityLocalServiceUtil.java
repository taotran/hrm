...
public class UniversityLocalServiceUtil {
    ...
    */
    ...
    public static org.json.JSONArray filterUniversitiesByTermDynamicQuery(
        java.lang.String term, int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService()
                   .filterUniversitiesByTermDynamicQuery(term, start, end);
    }

    public static int filterUniversitiesByTermSizeDynamicQuery(
        java.lang.String term)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().filterUniversitiesByTermSizeDynamicQuery(term);
    }

    public static org.json.JSONArray filterUniversitiesByTerm(
        java.lang.String term, int start, int end) {
        return getService().filterUniversitiesByTerm(term, start, end);
    }

    public static int filterUniversitiesByTermSize(java.lang.String term) {
        return getService().filterUniversitiesByTermSize(term);
    }
