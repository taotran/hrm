...
/**
 * The base model implementation for the Interview service. Represents a row in the &quot;HRM_Interview&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class InterviewModelImpl extends BaseModelImpl<Interview>
     ...
     */
    public static final String TABLE_NAME = "HRM_Interview";
    ...
    public static final String TABLE_SQL_CREATE = "create table HRM_Interview (interviewId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null)";
    public static final String TABLE_SQL_DROP = "drop table HRM_Interview";
    public static final String ORDER_BY_JPQL = " ORDER BY interview.interviewId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY HRM_Interview.interviewId ASC";
