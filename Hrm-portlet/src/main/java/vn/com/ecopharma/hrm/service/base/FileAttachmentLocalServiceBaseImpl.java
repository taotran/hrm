...
/**
 * Provides the base implementation for the file attachment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.ecopharma.hrm.service.impl.FileAttachmentLocalServiceImpl}.
 * </p>
 *
 * @author tvt
 * @see vn.com.ecopharma.hrm.service.impl.FileAttachmentLocalServiceImpl
 * @see vn.com.ecopharma.hrm.service.FileAttachmentLocalServiceUtil
 * @generated
 */
public abstract class FileAttachmentLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements FileAttachmentLocalService,
        IdentifiableBean {
    ...
    private FileAttachmentLocalServiceClpInvoker _clpInvoker = new FileAttachmentLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link vn.com.ecopharma.hrm.service.FileAttachmentLocalServiceUtil} to access the file attachment local service.
     */
    ...
    @Override
    public FileAttachment addFileAttachment(FileAttachment fileAttachment)
        throws SystemException {
        fileAttachment.setNew(true);

        return fileAttachmentPersistence.update(fileAttachment);
    }
     ...
     */
    @Override
    public FileAttachment createFileAttachment(long f_id) {
        return fileAttachmentPersistence.create(f_id);
    }
    ...
    @Override
    public FileAttachment deleteFileAttachment(long f_id)
        throws PortalException, SystemException {
        return fileAttachmentPersistence.remove(f_id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public FileAttachment deleteFileAttachment(FileAttachment fileAttachment)
        throws SystemException {
        return fileAttachmentPersistence.remove(fileAttachment);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(FileAttachment.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return fileAttachmentPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return fileAttachmentPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public FileAttachment fetchFileAttachment(long f_id)
        throws SystemException {
        return fileAttachmentPersistence.fetchByPrimaryKey(f_id);
    }
     ...
     */
    @Override
    public FileAttachment getFileAttachment(long f_id)
        throws PortalException, SystemException {
        return fileAttachmentPersistence.findByPrimaryKey(f_id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return fileAttachmentPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<FileAttachment> getFileAttachments(int start, int end)
        throws SystemException {
        return fileAttachmentPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getFileAttachmentsCount() throws SystemException {
        return fileAttachmentPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public FileAttachment updateFileAttachment(FileAttachment fileAttachment)
        throws SystemException {
        return fileAttachmentPersistence.update(fileAttachment);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("vn.com.ecopharma.hrm.model.FileAttachment",
            fileAttachmentLocalService);
    }
