...
/**
 * The base model implementation for the Candidate service. Represents a row in the &quot;HRM_Recruitment_Candidate&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class CandidateModelImpl extends BaseModelImpl<Candidate>
     ...
     */
    public static final String TABLE_NAME = "HRM_Recruitment_Candidate";
    ...
    public static Candidate toModel(CandidateSoap soapModel) {
        ...
        model.setCandidate_status(soapModel.getCandidate_status());
    ...
    public Object clone() {
        ...
        candidateImpl.setCandidate_status(getCandidate_status());
    ...
    public CacheModel<Candidate> toCacheModel() {
        ...
        candidateCacheModel.candidate_status = getCandidate_status();

        String candidate_status = candidateCacheModel.candidate_status;

        if ((candidate_status != null) && (candidate_status.length() == 0)) {
            candidateCacheModel.candidate_status = null;
        }
