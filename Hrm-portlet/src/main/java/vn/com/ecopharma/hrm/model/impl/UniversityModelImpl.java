...
/**
 * The base model implementation for the University service. Represents a row in the &quot;HRM_Recruitment_University&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class UniversityModelImpl extends BaseModelImpl<University>
     ...
     */
    public static final String TABLE_NAME = "HRM_Recruitment_University";
    ...
    public static final String TABLE_SQL_CREATE = "create table HRM_Recruitment_University (universityId LONG not null primary key,name VARCHAR(75) null,code_ VARCHAR(75) null,tel_fax VARCHAR(75) null,groupId LONG,companyId LONG,userId LONG,createDate DATE null,modifiedDate DATE null)";
    public static final String TABLE_SQL_DROP = "drop table HRM_Recruitment_University";
    public static final String ORDER_BY_JPQL = " ORDER BY university.universityId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY HRM_Recruitment_University.universityId ASC";
