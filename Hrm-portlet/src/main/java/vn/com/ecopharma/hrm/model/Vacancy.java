...
/**
 * The extended model interface for the Vacancy service. Represents a row in the &quot;HRM_Recruitment_Vacancy&quot; database table, with each column mapped to a property of this class.
 *
 * @author tvt
 * @see VacancyModel
