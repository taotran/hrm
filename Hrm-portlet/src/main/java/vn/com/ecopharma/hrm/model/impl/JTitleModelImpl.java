...
/**
 * The base model implementation for the JTitle service. Represents a row in the &quot;HRM_Recruitment_JTitle&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class JTitleModelImpl extends BaseModelImpl<JTitle>
     ...
     */
    public static final String TABLE_NAME = "HRM_Recruitment_JTitle";
    ...
    public static final String TABLE_SQL_CREATE = "create table HRM_Recruitment_JTitle (jobtitleId LONG not null primary key,title VARCHAR(75) null,description VARCHAR(75) null,note VARCHAR(75) null,isDeleted BOOLEAN,user_id LONG,group_id LONG)";
    public static final String TABLE_SQL_DROP = "drop table HRM_Recruitment_JTitle";
    public static final String ORDER_BY_JPQL = " ORDER BY jTitle.jobtitleId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY HRM_Recruitment_JTitle.jobtitleId ASC";
