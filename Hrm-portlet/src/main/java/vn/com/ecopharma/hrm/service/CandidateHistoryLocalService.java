...
/**
 * Provides the local service interface for CandidateHistory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author tvt
 * @see CandidateHistoryLocalServiceUtil
...
public interface CandidateHistoryLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link CandidateHistoryLocalServiceUtil} to access the candidate history local service. Add custom service methods to {@link vn.com.ecopharma.hrm.service.impl.CandidateHistoryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
