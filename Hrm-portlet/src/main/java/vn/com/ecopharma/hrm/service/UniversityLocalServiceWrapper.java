...
public class UniversityLocalServiceWrapper implements UniversityLocalService,
    ...
    */
    ...
    public org.json.JSONArray filterUniversitiesByTermDynamicQuery(
        ...
        throws com.liferay.portal.kernel.exception.SystemException {
        return _universityLocalService.filterUniversitiesByTermDynamicQuery(term,
            start, end);
    }
    ...
    public int filterUniversitiesByTermSizeDynamicQuery(java.lang.String term)
        throws com.liferay.portal.kernel.exception.SystemException {
        return _universityLocalService.filterUniversitiesByTermSizeDynamicQuery(term);
    }

    @Override
    public org.json.JSONArray filterUniversitiesByTerm(java.lang.String term,
        int start, int end) {
        return _universityLocalService.filterUniversitiesByTerm(term, start, end);
    }

    @Override
    public int filterUniversitiesByTermSize(java.lang.String term) {
        return _universityLocalService.filterUniversitiesByTermSize(term);
    }

    @Override
    public int countAll()
        throws com.liferay.portal.kernel.exception.SystemException {
        return _universityLocalService.countAll();
    }
