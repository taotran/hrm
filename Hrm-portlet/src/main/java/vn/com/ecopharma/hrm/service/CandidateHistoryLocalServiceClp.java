 ...
 * @generated
 */
public class CandidateHistoryLocalServiceClp
    ...
    public CandidateHistoryLocalServiceClp(
    ...
    public vn.com.ecopharma.hrm.model.CandidateHistory addCandidateHistory(
        ...
        return (vn.com.ecopharma.hrm.model.CandidateHistory) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public vn.com.ecopharma.hrm.model.CandidateHistory createCandidateHistory(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { candidateHistoryId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public vn.com.ecopharma.hrm.model.CandidateHistory deleteCandidateHistory(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { candidateHistoryId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public vn.com.ecopharma.hrm.model.CandidateHistory fetchCandidateHistory(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { candidateHistoryId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public vn.com.ecopharma.hrm.model.CandidateHistory getCandidateHistory(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { candidateHistoryId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<vn.com.ecopharma.hrm.model.CandidateHistory> getCandidateHistories(
        ...
        return (java.util.List<vn.com.ecopharma.hrm.model.CandidateHistory>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public vn.com.ecopharma.hrm.model.CandidateHistory edit(
        ...
        try {
            ...
            if (t instanceof vn.com.ecopharma.hrm.NoSuchCandidateHistoryException) {
                throw (vn.com.ecopharma.hrm.NoSuchCandidateHistoryException) t;
            }
    ...
    public java.util.List<vn.com.ecopharma.hrm.model.CandidateHistory> findByCandidate(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName24,
                    _methodParameterTypes24, new Object[] { c_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
