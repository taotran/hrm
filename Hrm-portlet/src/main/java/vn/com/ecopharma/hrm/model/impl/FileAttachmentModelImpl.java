...
/**
 * The base model implementation for the FileAttachment service. Represents a row in the &quot;HRM_Recruitment_FileAttachment&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class FileAttachmentModelImpl extends BaseModelImpl<FileAttachment>
     ...
     */
    public static final String TABLE_NAME = "HRM_Recruitment_FileAttachment";
    ...
    public static final String TABLE_SQL_CREATE = "create table HRM_Recruitment_FileAttachment (f_id LONG not null primary key,groupId LONG,companyId LONG,userId LONG,createDate DATE null,modifiedDate DATE null,c_id LONG,name VARCHAR(75) null,file_type VARCHAR(75) null,size_ LONG,content VARCHAR(75) null,attachment_type VARCHAR(75) null)";
    public static final String TABLE_SQL_DROP = "drop table HRM_Recruitment_FileAttachment";
    public static final String ORDER_BY_JPQL = " ORDER BY fileAttachment.f_id ASC";
    public static final String ORDER_BY_SQL = " ORDER BY HRM_Recruitment_FileAttachment.f_id ASC";
