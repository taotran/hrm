 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link vn.com.ecopharma.hrm.service.JTitleLocalService} interface.
 *
 * <p>
...
public class JTitleLocalServiceImpl extends JTitleLocalServiceBaseImpl {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never reference this interface directly. Always use {@link vn.com.ecopharma.hrm.service.JTitleLocalServiceUtil} to access the j title local service.
     */
	...
	public List<JTitle> findAll(int start, int end, OrderByComparator orderByComparator) {
		try {
	...
	public JTitle create(long user_Id, long group_Id, String title, String description, String note, boolean isDeleted, ServiceContext serviceContext) {
		try {
			...
			jTitle.setUser_id(user_Id);
			jTitle.setGroup_id(serviceContext.getScopeGroupId());
	...
	public JTitle edit(long user_Id, long group_Id, long j_id, String title, String description, String note, boolean isDeleted, ServiceContext serviceContext) {
		try {
