...
public class EmployeePersistenceImpl extends BasePersistenceImpl<Employee>
    ...
    protected Employee toUnwrappedModel(Employee employee) {
        ...
        employeeImpl.setTitlesId(employee.getTitlesId());
        employeeImpl.setLevelId(employee.getLevelId());
        employeeImpl.setPromoted_date(employee.getPromoted_date());
        employeeImpl.setLabour_contract_signed_date(employee.getLabour_contract_signed_date());
        employeeImpl.setLabour_contract_expired_date(employee.getLabour_contract_expired_date());
        employeeImpl.setLabour_contract_type(employee.getLabour_contract_type());
        employeeImpl.setGender(employee.getGender());
        employeeImpl.setPlace_of_birth(employee.getPlace_of_birth());
        employeeImpl.setEducation(employee.getEducation());
        employeeImpl.setEducation_specialize(employee.getEducation_specialize());
        employeeImpl.setUniversityId(employee.getUniversityId());
        employeeImpl.setMarital_status(employee.getMarital_status());
        employeeImpl.setIdentityCardNo(employee.getIdentityCardNo());
        employeeImpl.setIssued_date(employee.getIssued_date());
        employeeImpl.setIssued_place(employee.getIssued_place());
        employeeImpl.setAddressId(employee.getAddressId());
        employeeImpl.setCompany_email(employee.getCompany_email());
        employeeImpl.setPersonal_tax_code(employee.getPersonal_tax_code());
        employeeImpl.setNumber_of_dependents(employee.getNumber_of_dependents());
        employeeImpl.setDependent_names(employee.getDependent_names());
        employeeImpl.setSocial_insurance_no(employee.getSocial_insurance_no());
        employeeImpl.setHealth_insurance_no(employee.getHealth_insurance_no());
        employeeImpl.setBank_account_no(employee.getBank_account_no());
        employeeImpl.setBank_branch_name(employee.getBank_branch_name());
        employeeImpl.setBase_wage_rates(employee.getBase_wage_rates());
        employeeImpl.setPosition_wage_rates(employee.getPosition_wage_rates());
        employeeImpl.setCapacity_salary(employee.getCapacity_salary());
        employeeImpl.setTotal_salary(employee.getTotal_salary());
        employeeImpl.setBonus(employee.getBonus());
        employeeImpl.setResigned_date(employee.getResigned_date());
        employeeImpl.setEmployee_userId(employee.getEmployee_userId());
        ...
        employeeImpl.setIsDeleted(employee.isIsDeleted());
        employeeImpl.setCompanyEmailAddress(employee.getCompanyEmailAddress());
