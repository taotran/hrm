...
/**
 * The base model implementation for the SubUnit service. Represents a row in the &quot;pf_SubUnit&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class SubUnitModelImpl extends BaseModelImpl<SubUnit>
     ...
     */
    public static final String TABLE_NAME = "pf_SubUnit";
    ...
    public static final String TABLE_SQL_CREATE = "create table pf_SubUnit (subUnitId LONG not null primary key,name VARCHAR(75) null,groupId LONG,companyId LONG,userId LONG,createDate DATE null,modifiedDate DATE null)";
    public static final String TABLE_SQL_DROP = "drop table pf_SubUnit";
    public static final String ORDER_BY_JPQL = " ORDER BY subUnit.subUnitId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY pf_SubUnit.subUnitId ASC";
