...
/**
 * The extended model interface for the Candidate service. Represents a row in the &quot;pf_Candidate&quot; database table, with each column mapped to a property of this class.
 *
 * @author tvt
 * @see CandidateModel
