 ...
 * {@link vn.com.ecopharma.hrm.service.SubUnitLocalService} interface.
 *
 * <p>
...
public class SubUnitLocalServiceImpl extends SubUnitLocalServiceBaseImpl {
	 ...
	 * vn.com.ecopharma.hrm.service.SubUnitLocalServiceUtil} to access the sub
	 * unit local service.
	 */
	...
	public SubUnit create(String name, long userId,
			ServiceContext serviceContext) throws SystemException {
		SubUnit subUnit = subUnitPersistence.create(counterLocalService
				.increment());
