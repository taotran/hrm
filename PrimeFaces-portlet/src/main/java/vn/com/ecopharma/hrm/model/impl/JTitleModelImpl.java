...
/**
 * The base model implementation for the JTitle service. Represents a row in the &quot;pf_JTitle&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class JTitleModelImpl extends BaseModelImpl<JTitle>
     ...
     */
    public static final String TABLE_NAME = "pf_JTitle";
    ...
    public static final String TABLE_SQL_CREATE = "create table pf_JTitle (jobtitleId LONG not null primary key,title VARCHAR(75) null,description VARCHAR(75) null,note VARCHAR(75) null,isDeleted BOOLEAN,userId LONG,groupId LONG)";
    public static final String TABLE_SQL_DROP = "drop table pf_JTitle";
    public static final String ORDER_BY_JPQL = " ORDER BY jTitle.jobtitleId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY pf_JTitle.jobtitleId ASC";
    ...
    public Object clone() {
        ...
        jTitleImpl.setUserId(getUserId());
        jTitleImpl.setGroupId(getGroupId());
    ...
    public CacheModel<JTitle> toCacheModel() {
        ...
        jTitleCacheModel.userId = getUserId();

        jTitleCacheModel.groupId = getGroupId();
