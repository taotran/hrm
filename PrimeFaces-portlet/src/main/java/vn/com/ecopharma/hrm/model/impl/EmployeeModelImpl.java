...
/**
 * The base model implementation for the Employee service. Represents a row in the &quot;pf_Employee&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class EmployeeModelImpl extends BaseModelImpl<Employee>
     ...
     */
    public static final String TABLE_NAME = "pf_Employee";
    ...
    public static final String TABLE_SQL_CREATE = "create table pf_Employee (employeeId LONG not null primary key,emp_code VARCHAR(75) null,contact_number VARCHAR(75) null,birthday DATE null,jobtitleId LONG,joined_date DATE null,subUnitId LONG,titlesId LONG,levelId LONG,promoted_date DATE null,labour_contract_signed_date DATE null,labour_contract_expired_date DATE null,labour_contract_type VARCHAR(75) null,gender VARCHAR(75) null,place_of_birth VARCHAR(75) null,education VARCHAR(75) null,education_specialize VARCHAR(75) null,universityId LONG,marital_status VARCHAR(75) null,identityCardNo VARCHAR(75) null,issued_date DATE null,issued_place VARCHAR(75) null,addressId LONG,company_email VARCHAR(75) null,personal_tax_code VARCHAR(75) null,number_of_dependents INTEGER,dependent_names VARCHAR(75) null,social_insurance_no VARCHAR(75) null,health_insurance_no VARCHAR(75) null,bank_account_no VARCHAR(75) null,bank_branch_name VARCHAR(75) null,base_wage_rates DOUBLE,position_wage_rates DOUBLE,capacity_salary DOUBLE,total_salary DOUBLE,bonus DOUBLE,resigned_date DATE null,employee_userId LONG,groupId LONG,companyId LONG,userId LONG,createDate DATE null,modifiedDate DATE null,isDeleted BOOLEAN,companyEmailAddress VARCHAR(75) null)";
    public static final String TABLE_SQL_DROP = "drop table pf_Employee";
    public static final String ORDER_BY_JPQL = " ORDER BY employee.employeeId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY pf_Employee.employeeId ASC";
    ...
    public Object clone() {
        ...
        employeeImpl.setTitlesId(getTitlesId());
        employeeImpl.setLevelId(getLevelId());
        ...
        employeeImpl.setCompanyEmailAddress(getCompanyEmailAddress());
    ...
    public CacheModel<Employee> toCacheModel() {
        ...
        employeeCacheModel.titlesId = getTitlesId();

        employeeCacheModel.levelId = getLevelId();
        ...
        employeeCacheModel.companyEmailAddress = getCompanyEmailAddress();

        String companyEmailAddress = employeeCacheModel.companyEmailAddress;

        if ((companyEmailAddress != null) &&
                (companyEmailAddress.length() == 0)) {
            employeeCacheModel.companyEmailAddress = null;
        }
