    ...
    */
    ...
    public static vn.com.ecopharma.hrm.model.Employee addEmployee(
        ...
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService()
                   .addEmployee(e, creatorUserId, companyId, autoPassword,
            password1, password2, autoScreenName, screenName, emailAddress,
            facebookId, openId, locale, firstName, middleName, lastName,
            prefixId, suffixId, male, birthdayMonth, birthdayDay, birthdayYear,
            groupIds, organizationIds, roleIds, userGroupIds, sendEmail,
            emp_userId, addresses, serviceContext);
    }

    public static vn.com.ecopharma.hrm.model.Employee update(
        vn.com.ecopharma.hrm.model.Employee employee,
        ...
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService()
                   .update(employee, user, jTitle, subUnit, titles, level,
            university, addresses, serviceContext);
    }

    public static vn.com.ecopharma.hrm.model.Employee markDeletedEmployee(
        vn.com.ecopharma.hrm.model.Employee employee)
        throws com.liferay.portal.kernel.exception.SystemException,
